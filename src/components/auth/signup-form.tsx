...
export function SignupForm() {
  ...
  const handleCredentialsSignUp = async (event: FormEvent) => {
    ...
    try {
      ...
      if (signInResult?.error) {
        // This might happen if there's an issue with the authorize callback, though unlikely if registration succeeded
        ...
        router.push('/dashboard'); // Or signInResult.url
      }
    } catch (error: any) {
